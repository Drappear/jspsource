	...
	<main>
		<div class="container py-4">
			<header class="pb-3 mb-4 border-bottom">
				<a href="/list.do?criteria=&keyword=&page=1&amount=10" class="d-flex align-items-center text-body-emphasis text-decoration-none">
					...
					<span class="fs-4">BoardList</span>
				</a>
			</header>
